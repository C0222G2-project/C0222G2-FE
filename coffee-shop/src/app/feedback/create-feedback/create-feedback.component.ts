          ...
          fileRef.getDownloadURL().subscribe((url) => {
            ...
            this.feedbackService.createFeedback(feedback).subscribe(
              () => {
                ...
                //   let errCode = errs[i].code;
                //   switch (errs[i].field) {
                //     case "creator":
                //       switch (errCode) {
                //         case 'Size':
                //           this.feedbackFrom.controls.creator.setErrors({'Size': true});
                //           break;
                //         case 'Pattern':
                //           this.feedbackFrom.controls.creator.setErrors({'Pattern': true});
                //           break;
                //         case 'NotBlank':
                //           this.feedbackFrom.controls.creator.setErrors({'NotBlank': true});
                //           break;
                //       }
                //       break;
                //   }
